...
namespace IT.Users
{
    ...
    {
        private const string apiAuthLog = "http://172.31.224.1:2080/";

        public void LogRequest( username)
        {
            ...
            request.AddParameter("application/json", username, ParameterType.RequestBody);
